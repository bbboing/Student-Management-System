...
class reissueApplyForm extends Component {
    ...
    handleSubmit = e => {
        ...
        axios.post("http://127.0.0.1:8081/ressiueApply",data)
        .then(res=>{
...
const RessiueApplyForm = Form.create({ name: 'normal_ressiue' })(reissueApplyForm);
export default RessiueApplyForm;