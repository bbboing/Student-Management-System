...
import './ApplyForm1.css'
import current from '../../current.js'
import formatDate from '../../utils/formatDate'
const { Option } = Select;
const { TextArea } = Input

class ApplyForm1 extends Component {
    ...
    handleSubmit = e => {
        ...
        var family= this.props.form.getFieldsValue().family
        if(!reason||!destination||!family){
          alert('消息不能为空')
          return 0
        }
        var data = {
        ...
        axios.post("http://127.0.0.1:8081/poorApply",data)
        .then(res=>{
...
const NormalApplyForm = Form.create({ name: 'normal_poor' })(ApplyForm1);
export default NormalApplyForm;